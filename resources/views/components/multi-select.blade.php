...
<div>
    ...
    <div x-data="dropdown()" x-init="loadOptions()" class="w-full flex flex-col items-center h-64 mx-auto">
        {{-- <form> --}}
            <input {!! $attributes !!} type="hidden" x-bind:value="selectedValues()">
                ...
                <div class="flex flex-col items-center relative">
                    ...
                    <div class="w-full px-4">
                        <div x-show.transition.origin.top="isOpen()"
                            class="absolute shadow top-100 bg-white z-50 w-full lef-0 rounded max-h-select overflow-y-auto svelte-5uyqqj"
            ...
            {{-- <button class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded" type="submit">Test</button>
        </form> --}}
    </div>
